            ...
            <form action="div.php" method='POST'>
                ...
                <?php
                    if (isset($_POST['num1']) && isset($_POST['num2'])):
                        ...
                        $_SESSION['numDiv1'] = $_POST['num1'];
                        $_SESSION['numDiv2'] = $_POST['num2'];
                        ...
                        $_SESSION['repDiv'] = div($_POST['num1'], $_POST['num2']);
                        
                        if (!isset($_SESSION['numOp'])) {
                            $_SESSION['numOp'] = [];
                        }
                        if ($_SESSION['repDiv'] !== NULL) {
                            if (!isset($_SESSION['nameOp'])) {
                                $_SESSION['nameOp'] = [];
                            }
                        array_push($_SESSION['nameOp'], 'Division');
                        array_push($_SESSION['numOp'], $_SESSION['repDiv']);
                        }
                    }
                    endif;
                    ?>
